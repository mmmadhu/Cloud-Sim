	        ...
	        try {
	        	// First step: Initialize the CloudSim package. It should be called
	            	...
	            	broker.bindCloudletToVm(cloudlet2.getCloudletId(),vm2.getId());
                        ...
                        broker.bindCloudletToVm(cloudlet7.getCloudletId(),vm1.getId());
                        broker.bindCloudletToVm(cloudlet8.getCloudletId(),vm2.getId());
                        broker.bindCloudletToVm(cloudlet9.getCloudletId(),vm1.getId());
                        broker.bindCloudletToVm(cloudlet10.getCloudletId(),vm2.getId());
